...
if( $animal == "Chat" || "Chien" && $vivant && $couleur == "Marron" && $yeux == "Vert" ){
  echo 'Oui';
}else {
  echo 'Non';
}
...
/** remplacer le chiffre 0 par les bonnes conditions **/
if( $animal == "Chat" && $vivant && $couleur == "Marron" || $couleur == "Blanc" && $yeux == "Vert" ){
  echo 'Oui';
}else {
  echo 'Non';
}
...
/** remplacer le chiffre 0 par les bonnes conditions **/
if(($animal == "Chien" && $vivant && $couleur == "Noir" && $yeux == "Bleu") || ($animal == "Chat" && !$vivant && $couleur == 'Orange' && $yeux == "Bleu")){
  echo 'Oui';
}else {
  echo 'Non';
}
